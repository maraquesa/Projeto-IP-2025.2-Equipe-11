...
lista_bonus_disponiveis = [('velocidade', 3, 2), ('bome', 1, 2), ('obsta', 5, 1), ('tele', 1, 1)] #lista com todos os bonus possiveis e os pesos dele ser escolhido quando um coletavel secundario spawnar, cada elemento é uma tupla do tipo (elemento, peso, duração efeito em segundos)
velocidade_bomerangue = 20
